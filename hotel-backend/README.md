...
[![Quality Gate](https://YOUR_SONAR_HOST/api/project_badges/measure?project=hotel-backend&metric=alert_status&token=YOUR_BADGE_TOKEN)](https://YOUR_SONAR_HOST/dashboard?id=hotel-backend)
[![Coverage](https://YOUR_SONAR_HOST/api/project_badges/measure?project=hotel-backend&metric=coverage&token=YOUR_BADGE_TOKEN)](https://YOUR_SONAR_HOST/dashboard?id=hotel-backend)
