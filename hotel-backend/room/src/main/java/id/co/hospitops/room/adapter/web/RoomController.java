...
@RestController @RequestMapping("/api/v1/rooms") @RequiredArgsConstructor
public class RoomController {
    private final ManageRoomUseCase      manageUseCase;
    private final RoomAvailabilityUseCase availabilityUseCase;

    @GetMapping @PreAuthorize("hasAnyRole('ADMIN','MANAGER','FRONT_DESK')")
    ...
    @GetMapping("/available") @PreAuthorize("hasAnyRole('ADMIN','MANAGER','FRONT_DESK')")
