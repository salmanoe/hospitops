...
/**
 * Exception → HTTP response mapping scoped to the group module's web adapter.
 *
 ...
 * </ol>
 */
@RestControllerAdvice(basePackageClasses = GroupExceptionHandler.class)
class GroupExceptionHandler extends BaseApiExceptionHandler {
}
